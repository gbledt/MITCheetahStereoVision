...
hold on;
plot3(point_data.points_robot_frame_crop(:,1),point_data.points_robot_frame_crop(:,2),point_data.points_robot_frame_crop(:,3),'r.','MarkerSize',2)
%axis([0,8,-3,3,-3,3])
